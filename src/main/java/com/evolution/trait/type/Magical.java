...
/**
 * Trait which makes all damage bypass armor
 */
public class Magical implements ITraitType
{
    public static final ResourceLocation      ID         = ResourceLocation.fromNamespaceAndPath(Evolution.MOD_ID, "magical");
    ...
    {
        return Component.translatable("evolution.trait.magical", ITraitType.levelToString(trait.getLevel()));
    }
}
